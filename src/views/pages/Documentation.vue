<template>
    <div class="card">
        ...
        <p class="text-lg mb-4">
            ...
            <a href="https://github.com/vuejs/create-vue" class="font-medium text-primary hover:underline">create-vue</a>
...
<code>modules: [
    '@primevue/nuxt-module',
        ...
        <p class="text-lg mb-4">
            Install
            <a href="https://tailwindcss.com/docs/guides/nuxtjs" class="font-medium text-primary hover:underline">Tailwind CSS</a>
            with Nuxt using official documentation.
        </p>

        <p class="text-lg mb-4">
            Add
            <span class="bg-highlight px-2 py-1 rounded-border not-italic text-base">tailwindcss-primeui</span>
            package as a plugin to
            <span class="bg-highlight px-2 py-1 rounded-border not-italic text-base">tailwind.config.js</span>
        </p>
        <pre class="app-code">
...
&lt;/template&gt;</code></pre>
        ...
        <p class="text-lg mb-4">
            Create
            <span class="bg-highlight px-2 py-1 rounded-border not-italic text-base">layouts/default.vue</span>
            and paste this code:
        </p>
        <pre class="app-code">
<code>&lt;script setup&gt;
...
&lt;/template&gt;</code></pre>
        ...
        <p class="text-lg mb-4">
            ...
            <span class="bg-highlight px-2 py-1 rounded-border not-italic text-base">composables/use-layout.vue</span>
            and replace it with
            <span class="bg-highlight px-2 py-1 rounded-border not-italic text-base">src/layout/composables/layout.js</span>
